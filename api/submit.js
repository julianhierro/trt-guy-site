...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Fertility guide: the delivery email is sent by a GoHighLevel workflow that
    // fires on the `fertility-guide` tag — this proxy must NOT send its own copy,
    // or every opt-in gets the guide twice. Tagging above is what triggers it.
